...
engine = create_engine('mysql+mysqlconnector://alvin:alvin@202.124.205.201:3306/db_dws', echo=False)
dataku.to_sql(name='tb_pengamatan', con=engine, if_exists = 'append', index=True)
